...
public class Main {
    public static void main(String[] args) {
        ...
        Alarma sistemAlarma = new Alarma(false);
        ChaveCarro chave = new ChaveCarro(80);
        ...
        , sistemaEletrico , sistemaSuspensao , transmissao ,luzesFreio ,sistemAlarma ,chave , "Porsche" , 2019 , "Branco" , "FAN-2020" , 0 );
